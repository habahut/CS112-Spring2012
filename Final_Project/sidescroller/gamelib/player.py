...
class Player(Sprite):
    ...
    def update(self, dt):
        ...
        ## REDESIGNED COLLISION DETECTION:

        #coming soon....
        # check dX, whichever direction is positive use that edge of the rectangle
        # same with dy

        self.inair = True
        
        for sprite in self.touches(self.level.blocks):
            if sprite.getType() == "SPIKE":
                print "DEATH"

            if sprite.getType() == "NINJASTAR":
                print "SPIKED!"
